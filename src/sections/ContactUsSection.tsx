  ...
  return (
    ...
    >
      <div className="container mx-auto text-center max-w-4xl">
        <h2 className="text-4xl md:text-5xl font-extrabold text-[--color-text-main] mb-8">
          지금 바로{" "}
          <span className="text-[--color-primary-text]">무료 상담</span>{" "}
          신청하세요!
        </h2>
        <p className="text-lg md:text-xl text-[--color-text-paragraph] mb-12">
          농가 사장님의 소중한 수확물이 쿠팡에서 최고의 가치를 얻을 수 있도록,
          <br className="hidden md:block" />
          저희가 스마트하고 야무지게 도와드리겠습니다.
        </p>

        <Button
          onClick={() => window.open(googleDocsLink, "_blank")} // 새 탭으로 열기
          className="text-xl px-10 py-5 mb-12 shadow-lg hover:shadow-xl"
        >
          우리 농가 맞춤형 솔루션 문의하기
        </Button>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-12">
          ...
          <div className="flex items-center space-x-3 text-[--color-text-main]">
            ...
            <span className="text-lg md:text-xl">070-1234-5678</span>{" "}
            {/* 실제 전화번호로 변경 */}
          </div>
        </div>
      </div>
